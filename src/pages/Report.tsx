...
export default function ReportView({ result }: { result: TemplateInfo[] }) {
            ...
            <Tree aria-label="Default">
                ...
                <TreeItem itemType="branch">
                    <TreeItemLayout>
                        ...
                        <Tree appearance="transparent">
                            <TreeItem itemType='leaf'>

                                <TreeItemLayout><p>Mục tiêu tiến hành đánh giá, kiểm thử bao gồm:</p>

                                    <ScopeTable /></TreeItemLayout>
                            </TreeItem>
                        </Tree>
