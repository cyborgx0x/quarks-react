import { Body1Strong, Divider, Subtitle1, Text, Title1, makeStyles, shorthands } from "@fluentui/react-components";
...
export default function TemplateDetail({ item }: { item: Template }): ReactElement {
    ...
    return (
        <div className={classes.container}>
            ...
            <Divider />
            <Subtitle1>
                Tác giả: {" "} {data.info.author}
            </Subtitle1>
            <Text>
                Độ nghiêm trọng: {data.info.severity}
            </Text>
            <Text>
