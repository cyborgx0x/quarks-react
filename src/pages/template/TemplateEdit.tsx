...
export default function TemplateEdit({ item }: { item: Template }): ReactElement {
    ...
    return (
        <div className={classes.container}>
            ...
            <Input contentBefore={<DocumentRegular />} id={templateId} placeholder={data.id} value={data.id} disabled />
            <Label htmlFor={templateAuthor}>Author:</Label>
            <Input contentBefore={<Person />} id={templateAuthor} placeholder={data.info.author} value={data.info.author} disabled />

            <Divider />
            <Label htmlFor={templateTag}>Tag:</Label>
            <Input contentBefore={<Tag16Regular />} id={templateTag} placeholder={data.info.tags.toString()} value={data.info.tags.toString()} />
            <Divider />
            <Label htmlFor={templateDesc} size="medium">Mô tả:</Label>
            <Textarea resize="vertical" id={templateDesc} placeholder={data.info.description} value={data.info.description} />
